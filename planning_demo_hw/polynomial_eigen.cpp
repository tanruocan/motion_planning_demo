...
//	//}
//
//	X.eigen_creatVector(x0, vx0, ax0, x1, vx1, ax1);
//	Y.eigen_creatVector(y0, vy0, ay0, y1, vy1, ay1);
//	T.eigen_creatMat(t0, t1);
//	cout << endl;
//	cout << "X向量：" << endl;
//	cout << X.e_vector << endl;
//	//X.PrintMat();
//	cout << "Y向量：" << endl;
//	cout << Y.e_vector << endl;
//	//Y.PrintMat();
//	cout << "T矩阵：" << endl;
//	cout << T.e_matT << endl;
//	//T.PrintMat();
//
//	if (A.eigen_solve(T.e_matT, X.e_vector))
//	{
//		cout << "求得的A向量如下" << endl;
//		cout << A.e_solve << endl;
//	}
//	
//	if (B.eigen_solve(T.e_matT, Y.e_vector))
//	{
//		cout << "求得的B向量如下" << endl;
//		cout << B.e_solve << endl;
//	}
...
//	{
//		double x_temp = A.e_solve(0, 0) * pow(t, 5) + A.e_solve(1, 0) * pow(t, 4) + A.e_solve(2, 0) * pow(t, 3) + A.e_solve(3, 0) * pow(t, 2) + A.e_solve(4, 0) * pow(t, 1) + A.e_solve(5, 0);
//		double y_temp = B.e_solve(0, 0) * pow(t, 5) + B.e_solve(1, 0) * pow(t, 4) + B.e_solve(2, 0) * pow(t, 3) + B.e_solve(3, 0) * pow(t, 2) + B.e_solve(4, 0) * pow(t, 1) + B.e_solve(5, 0);
//
...
//	for (double t = t0; t <= t1; t += delta_time)
//	{
//		double vx_tmp = 5 * A.e_solve(0, 0) * pow(t, 4) + 4 * A.e_solve(1, 0) * pow(t, 3) + 3 * A.e_solve(2, 0) * pow(t, 2) + 2 * A.e_solve(3, 0) * pow(t, 1) + A.e_solve(4, 0);
//		double vy_tmp = 5 * B.e_solve(0, 0) * pow(t, 4) + 4 * B.e_solve(1, 0) * pow(t, 3) + 3 * B.e_solve(2, 0) * pow(t, 2) + 2 * B.e_solve(3, 0) * pow(t, 1) + B.e_solve(4, 0);
//
...
//	for (double t = t0; t <= t1; t += delta_time)
//	{
//		double ax_tmp = 20 * A.e_solve(0, 0) * pow(t, 3) + 12 * A.e_solve(1, 0) * pow(t, 2) + 6 * A.e_solve(2, 0) * pow(t, 1) + 2 * A.e_solve(3, 0);
//		double ay_tmp = 20 * B.e_solve(0, 0) * pow(t, 3) + 12 * B.e_solve(1, 0) * pow(t, 2) + 6 * B.e_solve(2, 0) * pow(t, 1) + 2 * B.e_solve(3, 0);
//
